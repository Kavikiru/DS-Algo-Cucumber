...
public class registerSteps {
	...
	private HomePagePF hPage=new HomePagePF(Helper.getDriver());
	private registerPagePF regPage= new registerPagePF(Helper.getDriver());
	...
	public void the_user_clicks_the_register_button_on_home_page() throws InterruptedException {
		...
		LoggerLoad.info("User clicks the Register Button on Homepage");
	...
	public void the_user_will_be_navigated_to_register_page_with_title_as(String string) {
		...
		LoggerLoad.info("User will be navigated to Register Page with title as 'REGISTRATION'");
	...
	public void the_user_clicks_the_register_button_on_register_page_with_all_fields_value_empty() throws InterruptedException, IOException {
		...
		LoggerLoad.error("User clicks Register Button on register page with all fields empty");
	}
	...
	LoggerLoad.error("Error message is displayed with 'Please fill out this field'");
	}
	...
	public void the_user_clicks_the_register_button_on_register_page_with_valid_username_and_password_fields_value_empty() throws IOException, InterruptedException {
		...
		LoggerLoad.error("User clicks the Register button on register page with valid Username and Password fields value empty");
	}
	...
	public void the_user_clicks_the_register_link_on_register_page_with_password_as_confirm_password_fields_value_empty(String pswrd) throws IOException, InterruptedException {
		...
		LoggerLoad.error("User click on register button with valid Username & Password and confirm Password field as blank ");
	}
	...
	//getting the testdata from excel and passing it to the user validation methods
		List<Map<String, String>> testdata = reader.getData("C:\\Users\\kirub\\eclipse-workspace\\DS_Algo_CucumberBDD\\src\\test\\resources\\Exceldata\\uservalidation.xlsx", sheetName);
		...
		LoggerLoad.error("User enter Invalid signUp details on register page from given Excelsheet");
	}
	...
	public void user_enter_valid_sign_up_details_on_register_page_user_name_password_as_and_confirm_password_as(String passwrd, String cnfrmPasswrd) throws InterruptedException {
	   ...
	   LoggerLoad.info("User enter valid Signupdetails on Register Page with Username,Password and ConfirmPassword ");
	}
	...
	public void success_message_will_be_displayed(String expMsg) throws IOException, InterruptedException {
		...
		Thread.sleep(2000);
		LoggerLoad.info("Success Message is displayed with Valid Signup Details");
