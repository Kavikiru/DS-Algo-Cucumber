...
public class queueSteps {
	...
	signInPagePF signPage= new signInPagePF(Helper.getDriver());
	HomePagePF hPage= new HomePagePF(Helper.getDriver());
    queuePagePF QueuePage=new queuePagePF(Helper.getDriver());
	String title;
	...
	public void user_enter_valid_python_code_in_try_editor_from_for_queue_topic_and_click_run_button(String pythonCodefrmFeature) throws InterruptedException {
	...
	LoggerLoad.info("User should be presented with the Run output for valid Python code and Message for for Queue Page");
	}

	@When("User Enter Invalid Python code in tryEditor from  {string} for Queue topic and click Run button")
	public void user_enter_invalid_python_code_in_try_editor_from_for_queue_topic_and_click_run_button(String pythonCodefrmFeature) throws InterruptedException {
	...
	public void user_should_be_presented_with_alert_and_no_run_output_for_invalid_python_code_for_queue_page() throws InterruptedException {
