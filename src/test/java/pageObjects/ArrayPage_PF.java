...
//	@FindBy(xpath = "//input[@value='Login']")WebElement logIn;
	...
	@FindBy(xpath = "//a[text()='Arrays in Python']")WebElement arrayInPytBtn;
	@FindBy(xpath = "//a[text()='Try here>>>']")WebElement tryHeredBtn;
	@FindBy(xpath = "//form[@id='answer_form']/div/div/div/textarea")WebElement Type;
	@FindBy(xpath = "//button[text()='Run']")WebElement Run;
	@FindBy(xpath = "//a[text()='Arrays Using List']")WebElement arrayUsiListBtn;
	@FindBy(xpath = "//a[text()='Basic Operations in Lists']")WebElement basicOpInListBtn;
	@FindBy(xpath = "//a[text()='Applications of Array']")WebElement AppOfArrBtn;
	@FindBy(xpath = "//a[text()='Practice Questions']")WebElement praQueBtn;
	@FindBy(xpath = "//a[text()='Search the array']")WebElement seaTheArrBtn;
	@FindBy(xpath = "//a[text()='Max Consecutive Ones']")WebElement maxConOnesBtn;
	@FindBy(xpath = "//a[text()='Find Numbers with Even Number of Digits']")WebElement findNumsBtn;
	@FindBy(xpath = "//a[text()='Squares of  a Sorted Array']")WebElement sortAreaBtn;
	@FindBy(xpath = "//pre[@id='output']")WebElement outputArray;
	@FindBy(xpath = "//span[@role='presentation']")WebElement sourceArray;
